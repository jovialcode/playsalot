...
export const DESIGN_GAMES: DesignGame[] = [
  {id:'gem-merchants', name:'왕국의 보석 상단', category:'보드', playersLabel:'2인', minP:2, maxP:2, activeNow:0, isNew:true, isPlayable:false, supportsBot:true, image:'/images/games/gem-merchants.png',
  ...
  {id:'uno', name:'우노', category:'카드', playersLabel:'2-8인', minP:2, maxP:8, activeNow:3842, isNew:false, isPlayable:false, supportsBot:false, image:'/images/games/uno.png',
  ...
  {id:'halli', name:'할리갈리', category:'반응', playersLabel:'2-6인', minP:2, maxP:6, activeNow:1205, isNew:true, isPlayable:false, supportsBot:false, image:'/images/games/halli.png',
  ...
  {id:'burumable', name:'부루마블 스타일', category:'보드', playersLabel:'2인', minP:2, maxP:2, activeNow:2976, isNew:false, isPlayable:false, supportsBot:false, image:'/images/games/burumable.png',
